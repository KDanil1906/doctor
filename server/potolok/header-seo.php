...
<!--    get_the_ID()-->
    <meta name="description" content="<?php echo makeServicesDesc(get_the_ID());?>" />
	<?php wp_head(); ?>
...
<header class="header">
    <a href="<?php echo home_url(); ?>" class="header__logo">
        ...
        <img src="<?php echo carbonImageData( $logo_id )['url']; ?>"
             loading="<?php echo carbonImageData( $logo_id )['url']; ?>" alt="<?php echo carbonImageData( $logo_id )['alt']; ?>">
    </a>
